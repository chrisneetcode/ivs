...
if (
    ...
    empty($stock_type) || empty($fund_cluster) || $initial_quantity < 0 ||
...
$stmt = $conn->prepare("
    ...
    (item_name, description, unit, stock_type, fund_cluster, initial_quantity, critical_level, date_added, status)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
");
$stmt->bind_param(
    "sssssiiss",
