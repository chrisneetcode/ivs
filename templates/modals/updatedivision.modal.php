      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="division_chief" name="division_chief" id="update_division_chief" class="form-control" required>
          </div>

                    <!-- Position -->
          <div class="mb-3">
            <label for="position" class="form-label">Position</label>
            <input type="position" name="position" id="update_position" class="form-control" required>
          </div>
